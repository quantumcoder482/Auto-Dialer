<template>
  <div>
    ...
    <v-container fluid grid-list-xl pt-0>
      <v-layout row wrap>
        <app-card :heading="$t('message.radiosDefault')" colClasses="xs12 md6">
        ...
        <app-card :heading="$t('message.radiosDirectionRow')" colClasses="xs12 md6">
      ...
      <v-layout row wrap>
        ...
        <app-card :heading="$t('message.radiosColors')" colClasses="xs12 md6">
          <v-layout row wrap>
      ...
      <v-layout row wrap>
        <app-card :heading="$t('message.switchesColors')" colClasses="lg12 col-height-auto">
          <v-layout row wrap>
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="red" v-model="ex11" color="red" value="red" hide-details></v-switch>
              <v-switch
                label="red darken-3"
                v-model="ex11"
                color="red darken-3"
            ...
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="indigo" v-model="ex11" color="indigo" value="indigo" hide-details></v-switch>
              <v-switch
            ...
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="orange" v-model="ex11" color="orange" value="orange" hide-details></v-switch>
              <v-switch
          ...
          <v-layout row wrap>
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="primary" v-model="ex11" color="primary" value="primary" hide-details></v-switch>
              <v-switch
                label="secondary"
                v-model="ex11"
                color="secondary"
            ...
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="success" v-model="ex11" color="success" value="success" hide-details></v-switch>
              <v-switch label="info" v-model="ex11" color="info" value="info" hide-details></v-switch>
            </v-flex>
            <v-flex xs12 sm6 md4 class="col-height-auto">
              <v-switch label="warning" v-model="ex11" color="warning" value="warning" hide-details></v-switch>
              <v-switch label="error" v-model="ex11" color="error" value="error" hide-details></v-switch>
            </v-flex>
          </v-layout>
        </app-card>
      </v-layout>
