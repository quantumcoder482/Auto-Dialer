...
<template>
	<div>
		...
		>
			...
			<div class="navbar-right">
				...
				<v-btn class="ma-0" icon large @click.stop="dialerSidebar = !dialerSidebar">
    ...
    <!-- Dialer Sidebar -->
    <v-navigation-drawer fixed v-model="dialerSidebar" :right="!rtlLayout" app :width="350" class="Vuely-sidebar" >
      <dialer></dialer>
    </v-navigation-drawer>
		<!-- Chat Searchbar
...
import Dialer from "../Dialer/AutoDialer.vue";
