...
export const menus = {
  'message.general': [{
      ...
      items: [{
        ...
        //  { title: 'Leads', path: '/default/leads', exact: true},
    ...
    },
    {
      ...
      active: false,
      items: [{
          title: 'message.contactsList',
          path: '/contacts',
          exact: true
        },
        {
          title: 'message.addNewContact',
          path: '/contacts/new',
          exact: true
        }
      ]
    ...
    // {
    //   action: 'zmdi-phone',
    //   title: 'message.autoDialer',
    //   active: false,
    //   items: [{
    //       title: 'message.dialer',
    //       path: '/dialer/autodialer',
    //       exact: true
    //     },
    //     {
    //       title: 'message.dialerSetting',
    //       path: '/dialer/setting',
    //       exact: true
    //     }
    //   ]
    ...
    // 	active: false,
    // 	items: [
    // 		{ title: 'message.sitesList', path: '/reporting/profile' },
    // 		{ title: 'message.addNewSite', path: '/reporting/list' },
    // 		{ title: 'message.documentation', path: '/reporting/documentation' },
    // 	]
    // },
    // {
    // 	action: 'zmdi-globe-lock',
    // 	title: 'message.sites',
    // 	active: false,
    // 	items: [
    // 		{ title: 'message.sitesList', path: '/sites/profile' },
    // 		{ title: 'message.addNewSite', path: '/sites' },
    // 		{ title: 'message.documentation', path: '/sites/documentation' },
    // 	]
    // },
    // {
    // 	action: 'zmdi-widgets',
